...
int main() {
  ...
  RUN_TEST(test_standard_speed_claims_are_exclusive_and_transactional);
  RUN_TEST(test_same_address_high_rebind_releases_standard_entitlement);
  RUN_TEST(test_successful_reset_preserves_standard_entitlement);
  RUN_TEST(test_high_config_resynchronization_releases_conservative_entitlement);
  RUN_TEST(test_same_speed_noop_is_bus_silent_and_not_health_evidence);
  RUN_TEST(test_ambiguous_standard_transition_retains_exclusivity_until_reset);
